...
const Categories = () => {
    return (
        <section className="rts-category-area rts-section-gap">
            <div className="container">
                <div className="section-title-area text-center">
                    <p className="pre-title justify-content-center"><img src="assets/images/banner/title-img.svg" alt="" />Kategori</p>
                    <h2 className="section-title">Topik kelas populer</h2>
                    <p className="desc">ditandai dengan pertumbuhan dan eksplorasi yang signifikan sebagai <br /> transisi balita dari masa bayi</p>
                </div>
                <div className="slider-inner">
                    <div className="swiper mySwiper-category-1 swiper-data" data-swiper='{
                        ...
                        <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                                <div className="category-wrapper">
                                    ...
                                    <div className="content">
                                        <h5 className="title"><a href="course.html">Bahasa</a></h5>
                                    </div>
                                </div>
                            </div>
                            {/* single swiper style */}
                            {/* single swiper style */}
                            <div className="swiper-slide">
                                <div className="category-wrapper two">
                                    <div className="wrapper-inner">
                                        <div className="icon">
                                            <a href="course.html">
                                    ...
                                    <div className="content">
                                        <h5 className="title"><a href="course.html">Coding</a></h5>
                                    </div>
                                </div>
                            </div>
                            {/* single swiper style */}
                            {/* single swiper style */}
                            <div className="swiper-slide">
                                <div className="category-wrapper three">
                                    <div className="wrapper-inner">
                                        <div className="icon">
                                            <a href="course.html">
                            ...
                            {/* single swiper style */}
                            <div className="swiper-slide">
                                <div className="category-wrapper four">
                                    <div className="wrapper-inner">
                                        <div className="icon">
                                            <a href="course.html">
                                    ...
                                    <div className="content">
                                        <h5 className="title"><a href="course.html">Musik</a></h5>
                                    </div>
                                </div>
                            </div>
                            {/* single swiper style */}
                            {/* single swiper style */}
                            <div className="swiper-slide">
                                <div className="category-wrapper five">
                                    <div className="wrapper-inner">
                                        <div className="icon">
                                            <a href="course.html">
                                    ...
                                    <div className="content">
                                        <h5 className="title"><a href="course.html">Menulis</a></h5>
                                    </div>
                                </div>
                            </div>
                            {/* single swiper style */}
